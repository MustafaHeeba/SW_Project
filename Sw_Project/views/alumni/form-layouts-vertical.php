        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.php" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">FCAI-HU Alumni</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class="text-truncate" data-i18n="Form Layouts">Registration</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="form-layouts-vertical.php" class="menu-link">
                    <div class="text-truncate" data-i18n="Vertical Form">Only alunmi</div>
                  </a>
                </li>
                    ...
                    <div class="card-body">
                      <form>
                        <div class="mb-6">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Your Name" />
                        </div>
                        <div class="mb-6">
                          <label class="form-label" for="basic-default-phone">ID</label>
                          <input
                            type="number"
                        ...
                        <div class="mb-4">
                          <label for="formFile" class="form-label">Graduation certificate</label>
